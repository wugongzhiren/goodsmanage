...
public class TicksInfo implements Printable {
    ...
    public TicksInfo(List<Goods> goods, String operatorName, String orderId, String totalPrice, String favorablePrice, String actualCollection, String giveChange) {
        this.goods = goods;
    ...
    public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) throws PrinterException {
        ...
        //设置小票的标题标题
        g2.drawString("****时尚购物店", (float) x + 35, (float) y + heigth);
...
//设置标题
        ...
        g2.drawString("数量", (float) x + 110, (float) y + line);
        g2.drawString("小计(元)", (float) x + 140, (float) y + line);
        line += heigth;
...
//设置商品清单
        if(goods!=null && goods.size()>0){
            for(Goods gdf:goods){
                ...
                g2.drawString(gdf.getPrice().toString(),(float)x+60, (float)y+line);
                g2.drawString(gdf.getGoodsCount()+"",(float)x+95,(float)y+line);
                g2.drawString(gdf.getSumPrice(),(float)x+120,(float)y+line);
                line += heigth;
            }
        }
        g2.drawLine((int) x, (int)(y+line), (int) x + 158, (int)(y+line));
